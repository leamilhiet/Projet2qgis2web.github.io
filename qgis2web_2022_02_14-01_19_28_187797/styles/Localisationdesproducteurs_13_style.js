...
var style_Localisationdesproducteurs_13 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("nom struct") !== null) {
        labelText = String(feature.get("nom struct"));
    }
